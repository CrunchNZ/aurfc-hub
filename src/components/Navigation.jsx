  ...
  const getNavItems = (role) => {
    ...
    const roleSpecificItems = {
      ...
      coach: [
        ...
        { path: '/performance', label: 'Performance', icon: BarChart3, roles: ['coach', 'manager'] },
        { path: '/player-development', label: 'Development', icon: TrendingUp, roles: ['coach', 'manager'] },
        { path: '/match-analysis', label: 'Match Analysis', icon: Target, roles: ['coach', 'manager'] },
        { path: '/season-stats', label: 'Season Stats', icon: Trophy, roles: ['coach', 'manager'] },
